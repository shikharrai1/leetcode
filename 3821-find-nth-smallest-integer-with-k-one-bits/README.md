<h2><a href="https://leetcode.com/problems/find-nth-smallest-integer-with-k-one-bits">3821. Find Nth Smallest Integer With K One Bits</a></h2><h3>Hard</h3><hr><p>You are given two positive integers <code>n</code> and <code>k</code>.</p>
